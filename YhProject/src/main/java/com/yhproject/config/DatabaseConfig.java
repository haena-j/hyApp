...
@MapperScan(basePackages = {"com.yhproject.persistence"})
public class DatabaseConfig {
    @Autowired
    private ApplicationContext applicationContext;    //application.yml을 읽어들인다. Map으로 읽을려면 ConfigurationProperties를 사용
    ...
    public SqlSessionFactory sqlSessionFactory() throws Exception {
        ...
        sessionFactoryBean.setTypeAliasesPackage("com.yhproject.domain");
